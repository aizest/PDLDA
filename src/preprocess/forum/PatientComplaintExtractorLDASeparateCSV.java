 ...
 *
 */
public class PatientComplaintExtractorLDASeparateCSV {
	
	public static String EARLIEST_YEAR = "2018";
	...
	public static List<Complaint> extractComplaints(Map<String, String> configMap) throws ParseException{
		...
		try {
			...
			for(int i = 1;i < entries.size(); i++){
				...
				Complaint cmpl = new Complaint(currentID, currentModel, currentComps, currentSMwords, currentResoWords, currentYear, date, content);
